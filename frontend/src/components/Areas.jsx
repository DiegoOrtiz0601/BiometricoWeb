...
const Areas = () => {
    ...
    const handleDelete = async (id) => {
        ...
        if (result.isConfirmed) {
            try {
                ...
                await axios.delete(`${import.meta.env.VITE_API_URL}/api/areas/${id}`);
                Swal.fire({
                    icon: 'success',
                    title: 'Éxito',
    ...
    const filteredAreas = areas.filter(area =>
        ...
        area.sede?.nombre.toLowerCase().includes(searchTerm.toLowerCase())
    );
                                ...
                                <AnimatePresence>
                                    {filteredAreas.map((area) => (
                                        ...
                                        >
                                            ...
                                            <TableCell>{area.sede?.nombre}</TableCell>
                                            <TableCell>
                                                <span
